...
public class PostController {
    ...
    @GetMapping("/search")
    public Mono<ResponseEntity<SuccessResponse<?>>> getSearchPosts(@RequestParam final String text,
                                                                   ServerHttpRequest request) {
        return postService.getSearchPosts(text, request);
    }

    @GetMapping("/{id}")
    public Mono<ResponseEntity<SuccessResponse<?>>> getPostInfo(@PathVariable("id") final Long postId,
    ...
    public Mono<ResponseEntity<SuccessResponse<?>>> getCategoryPost(@PathVariable final String moldevId,
